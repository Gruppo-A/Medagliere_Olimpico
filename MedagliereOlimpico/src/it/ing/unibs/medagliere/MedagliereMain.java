...
public class MedaglieMain {
	...
	public static void main(String[] args) {
		...
		String[] voci = { "Inserisci nuova nazione", "Inserisci nuova gara",
				"Inserisci il risultato di una gara", "Visualizza medagliere" };
		...
		do {
			...
			case 4:
				...
				break;
			case 5:
				// -**-COPIARE MESSAGGIO DI USCITA SCRITTO DA CADEI IN
				// ARCHIVIOCD!!!!!!
				continua = !(MyScanner
						.si_No(USCITA_ARCHIVIO + PUNTO_DI_DOMANDA));
			}
		} while (continua);
	}
}
