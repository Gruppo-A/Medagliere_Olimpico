...
public class Nazione {
	...
	public Nazione(String nome) {
		this.nome = nome;
		medaglie = new int[Medagliere.NUM_MEDAGLIE];
	}
	 ...
	 * 
	 * 
	 * public Nazione() { this(NOME_DEFAULT); medaglia = new
	 * int[Medaglie.NUM_MEDAGLIE]; }
	 */
	
	public int getOri()
	{
		return medaglie[Medaglie.ORO];
	}
	
	public int getArgenti()
	{
		return medaglie[Medaglie.ARGENTO];
	}
	
	public int getBronzi()
	{
		return medaglie[Medaglie.BRONZO];
	}
	 ...
	 *            il tipo della medaglia: - 1 per ORO, - 2 per ARGENTO, - 3 per
	 *            BRONZO
	 * 
	...
	public void aggiungiMedaglia(int valoreMedaglia)
	...
	public String toString() {
		...
		s.append(nome.toUpperCase() + " -> ");
		s.append(Medaglie.MEDAGLIE[0] + ": " + getOri() + ","  + " ");
		s.append(Medaglie.MEDAGLIE[1] + ": " + getArgenti() + ","  + " ");
		s.append(Medaglie.MEDAGLIE[2] + ": " + getBronzi());
